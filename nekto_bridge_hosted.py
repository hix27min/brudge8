...
class NektoClient:
    ...
    async def skip(self):
        if self.connection_id:
            ...
            # ставим флаг: следующий peer-disconnect от сервера — это наш ACK, игнорим
            ...
            try:
                ...
                pass
            await self._close_peer()
            # пауза чтобы сервер успел обработать peer-disconnect ДО нашего нового search
